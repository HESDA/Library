...
class BookRentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($book['status'] != 'in stock') {
            ...
            if ($count >= 3) {
                ...
                try {
                    DB::beginTransaction();
                    // Process insert to rent_logs_table
    ...
    {
        // user & buku yang dipilih untuk diretrun benar, maka berhasil return book
        // user & buku yang dipilih untuk diretrun salah, maka muncul eror notice
        ...
        if ($countData == 1) {
            ...
            //eror notice muncul
            Session::flash('message', 'The book is not Matched');
            Session::flash('alert-class', 'alert-danger');
            return redirect('book-return');
        }
    }
